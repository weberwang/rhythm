...
This project is indexed by GitNexus as **rhythm** (5799 symbols, 12884 relationships, 60 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
