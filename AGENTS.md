...
This project is indexed by GitNexus as **rhythm** (1529 symbols, 3017 relationships, 135 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
