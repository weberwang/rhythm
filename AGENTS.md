...
This project is indexed by GitNexus as **rhythm** (1479 symbols, 3082 relationships, 31 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
